...
public class CommonData {
    ...
    public static final int SUBID_ARCHITECTURE = 1;
    public static final int SUBID_EXCLUSIVE = 2;
    public static final int SUBID_AGERANGE0 = 3;

    public static final int SUBID_CASTLE = 4;
    public static final int SUBID_CITY = 5;
    public static final int SUBID_GALAXY = 6;
    public static final int SUBID_JUNIORS = 7;
    public static final int SUBID_STARWARS = 8;

    // keys of result info(screen positions and images)
    public static final int KEY_ARCHITECTURE = 0;
    public static final int KEY_EXCLUSIVE = 1;
    public static final int KEY_AGERANGE0 = 2;

    public static final int KEY_CASTLE = 4;
    public static final int KEY_CITY = 5;
    public static final int KEY_GALAXY = 6;
    public static final int KEY_JUNIORS = 7;
    public static final int KEY_STARWAS = 8;
